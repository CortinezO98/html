...
<head>
    ...
    <style>
        ...
        .ac-sector-top > .btn{margin-top:2.25rem}
        ...
        @media(max-width:767.98px){.ac-sector-page{padding-top:4.5rem}.ac-sector-top > .btn{margin-top:0}.ac-sector-top{flex-direction:column;align-items:stretch}.ac-sector-summary{grid-template-columns:1fr}}
    </style>
