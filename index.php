<?php
    ...
    if (isset($_POST["form_login"])) {
        ...
        if ($captcha_original !== '' && $captcha_original == sha1($captcha_validacion)) {
            ...
            $consulta_string = "SELECT `usu_id`, `usu_acceso`, `usu_contrasena`, `usu_nombres_apellidos`, `usu_correo_corporativo`,
                                       `usu_estado`, `usu_inicio_sesion`, `usu_campania`
...
<body>
    ...
    <!-- ✅ Actualizado a jQuery seguro (ya lo tenías en el proyecto) -->
