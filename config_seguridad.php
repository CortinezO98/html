<?php
    ...
    // Si sesion NO esta iniciada se redirige al login
    if (!isset($_SESSION["usu_id"]) || $_SESSION["usu_id"]==null || $_SESSION["usu_id"]=="") {
        header("Location:index.php");
        exit;
    }

    // ✅ Inicializa flag de sesión si no existe
    if (!isset($_SESSION['contrasena_actualizada'])) {
        $_SESSION['contrasena_actualizada'] = 0;
    }
    ...
    if (isset($_POST["guardar_registro"])) {
        ...
        if ((int)$_SESSION['contrasena_actualizada'] !== 1) {

            // Evita usar el ID como contraseña y valida coincidencia
            if ($contrasena === $contrasena_confirm && $contrasena !== (string)$usuario_registro) {
                ...
                if (comprobarSentencia($enlace_db->info)) {
                    ...
                    // ✅ MUY IMPORTANTE: actualiza sesión para que ya no lo vuelva a forzar
                    $_SESSION['usu_inicio_sesion'] = 1;
...
<html lang="ES">
<head>
	<?php include("config/configuracion_estilos_raiz.php"); ?>
</head>
<body>
    <div class="menu-bar">
        <a class="home">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="form-group">
                          ...
                          <input type="password" class="form-control" name="contrasena" id="contrasena"
                                 minlength="10" maxlength="15" value=""
                                 <?php if((int)$_SESSION['contrasena_actualizada']===1) { echo 'readonly'; } ?>
                                 required autofocus>
                        </div>

                        <div class="form-group">
                          <label for="contrasena_confirm">Confirme contraseña*</label>
                          <input type="password" class="form-control" name="contrasena_confirm" id="contrasena_confirm"
                                 minlength="10" maxlength="15" value=""
                                 <?php if((int)$_SESSION['contrasena_actualizada']===1) { echo 'readonly'; } ?>
                                 required>
                        </div>
                        ...
                        <div class="form-group">
                            <?php if((int)$_SESSION['contrasena_actualizada']===1): ?>
