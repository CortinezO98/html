                ...
                if ($_FILES['documento_comentario']["error"][$key] > 0) {
                  ...
                  /*ahora co la funcion move_uploaded_file lo guardaremos en el destino que queramos*/
                    if (move_uploaded_file($_FILES['documento_comentario']['tmp_name'][$key], $ruta_final)) {
                        ...
                        // Prepara la sentencia
                        $consulta_registro_soporte_insert = $enlace_db->prepare("INSERT INTO `tb_gestion_calibracion_monitoreo_historial_soportes`(`gcmhs_monitoreo`, `gcmhs_historial`, `gcmhs_nombre`, `gcmhs_ruta`, `gcmhs_extension`, `gcmhs_registro_usuario`) VALUES (?,?,?,?,?,?);");
