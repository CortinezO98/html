...
// ini_set('display_errors', '1');
    ...
    $consulta_string_matriz="SELECT `gcm_id`, `gcm_nombre_matriz`, `gcm_estado`, `gcm_observaciones`, `gcm_registro_usuario`, `gcm_registro_fecha` FROM `tb_gestion_calibracion_matriz` ORDER BY `gcm_nombre_matriz`";
    ...
    // $consulta_string_soportes="SELECT `gcms_id`, `gcms_monitoreo`, `gcms_nombre`, `gcms_ruta`, `gcms_extension`, `gcms_registro_usuario`, `gcms_registro_fecha` FROM `tb_gestion_calibracion_monitoreo_soportes` WHERE `gcms_registro_fecha`<? AND `gcms_registro_fecha`>=? ORDER BY `gcms_monitoreo` DESC";
