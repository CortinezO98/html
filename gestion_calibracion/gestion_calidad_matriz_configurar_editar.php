<?php
    ...
    if(isset($_POST["guardar_registro"])){
        ...
        $consulta_actualizar = $enlace_db->prepare("UPDATE `tb_gestion_calibracion_matriz_item` SET `gcmi_item_consecutivo`=?,`gcmi_descripcion`=?,`gcmi_peso`=?,`gcmi_calificable`=?,`gcmi_grupo_peso`=?,`gcmi_visible`=? WHERE `gcmi_id`=?");
    ...
    $consulta_string="SELECT `gcmi_id`, `gcmi_matriz`, `gcmi_item_tipo`, `gcmi_item_consecutivo`, `gcmi_item_orden`, `gcmi_descripcion`, `gcmi_peso`, `gcmi_calificable`, `gcmi_grupo_peso`, `gcmi_visible`, `gcmi_tipo_error`, `gcmi_grupo_id`, `gcmi_subgrupo_id`, `gcmi_item_id`, `gcmi_subitem_id` FROM `tb_gestion_calibracion_matriz_item` WHERE `gcmi_id`=?";
