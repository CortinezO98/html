<?php
    ...
    $titulo_header = "Matriz de Calidad | Editar";
    ...
    if(isset($_POST["guardar_registro"])){
        ...
        $consulta_actualizar = $enlace_db->prepare("UPDATE `tb_gestion_calibracion_matriz` SET `gcm_nombre_matriz`=?,`gcm_estado`=?,`gcm_observaciones`=? WHERE  `gcm_id`=?");

        // Agrega variables a sentencia preparada
        $consulta_actualizar->bind_param('ssss', $nombre_matriz, $estado, $observaciones, $id_registro);
    ...
    $consulta_string="SELECT `gcm_id`, `gcm_nombre_matriz`, `gcm_estado`, `gcm_observaciones`, `gcm_registro_usuario`, `gcm_registro_fecha` FROM `tb_gestion_calibracion_matriz` WHERE `gcm_id`=?";
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                          ...
                          <textarea class="form-control form-control-sm" name="observaciones" id="observaciones" maxlength="200" ><?php echo $resultado_registros[0][3]; ?></textarea>
                        </div>
                    </div>
                </div>
                <div class="row">
