<?php
    ...
    $consulta_string="SELECT `gcmi_id`, `gcmi_matriz`, `gcmi_item_tipo`, `gcmi_item_consecutivo`, `gcmi_item_orden`, `gcmi_descripcion`, `gcmi_peso`, `gcmi_calificable`, `gcmi_grupo_peso`, `gcmi_visible`, `gcmi_tipo_error` FROM `tb_gestion_calibracion_matriz_item` WHERE `gcmi_matriz`=?  AND `gcmi_item_tipo`='Grupo'";
