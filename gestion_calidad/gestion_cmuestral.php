<?php
    ...
    $titulo_header = "Calculadora Muestral";
    ...
    $consulta_contar_string="SELECT COUNT(`cm_id`) FROM `tb_gestion_calidad_cmuestral` LEFT JOIN `tb_administrador_usuario` AS TU ON `tb_gestion_calidad_cmuestral`.`cm_registro_usuario`=TU.`usu_id` WHERE 1=1 ".$filtro_buscar."";
    ...
    if (!isset($_GET['pagina']) || ($pagina>$numero_paginas AND $numero_paginas>0) || $pagina<=0) {
        header('Location:gestion_cmuestral.php?pagina=1&id=null');
    }
        ...
        <div class="row" id="elemento_1">
                ...
                <form name="filtrado" action="" method="POST">
                    <div class="input-group">
                      ...
                      <span class="input-group-btn">
                        ...
                        <a href="gestion_cmuestral.php?pagina=1&id=null" class="btn btn-corp"><span class="fas fa-sync-alt"></span></a>
                      </span>
                    </div>
                </form>
            </div>
            <div class="col-md-9 py-2">
                <?php if($perfil_modulo=="Administrador" OR $perfil_modulo=="Gestor"): ?>
                    <a href="gestion_cmuestral_crear.php?pagina=<?php echo $pagina; ?>&id=<?php echo $filtro_permanente; ?>" class="btn btn-corp menu float-right"><div class="float-left"><span class="fas fa-plus"></span></div><div class="pl-2 menu_res float-left">Crear Calculadora</div></a>
                <?php endif; ?>
            </div>
        </div>
                    ...
                    <div class="col-md-12 float-left">
                        <nav aria-label="Paginación" class="paginacion">
                            <ul class="pagination justify-content-end">
                                <li class="page-item <?php echo $pagina<=1 ? 'disabled':'' ?>"><a class="page-link" href="gestion_cmuestral.php?pagina=1&id=<?php echo $filtro_permanente; ?>"><span class="fas fa-angle-double-left"></span></a></li>
                                <li class="page-item <?php echo $pagina<=1 ? 'disabled':'' ?>"><a class="page-link" href="gestion_cmuestral.php?pagina=<?php echo $pagina-1; ?>&id=<?php echo $filtro_permanente; ?>"><span class="fas fa-angle-left"></span></a></li>
                                <?php
                                ...
                                <?php for ($i=$pagina_inicio; $i <= $pagina_fin; $i++): ?>
                                    <li class="page-item <?php echo $pagina==$i ? 'active':'' ?>"><a class="page-link" href="gestion_cmuestral.php?pagina=<?php echo $i; ?>&id=<?php echo $filtro_permanente; ?>"><?php echo $i; ?></a></li>
                                <?php endfor; ?>
                                <li class="page-item <?php echo $pagina>=$numero_paginas ? 'disabled':'' ?>"><a class="page-link" href="gestion_cmuestral.php?pagina=<?php echo $pagina+1; ?>&id=<?php echo $filtro_permanente; ?>"><span class="fas fa-angle-right"></a></li>
                                <li class="page-item <?php echo $pagina>=$numero_paginas ? 'disabled':'' ?>"><a class="page-link" href="gestion_cmuestral.php?pagina=<?php echo $numero_paginas; ?>&id=<?php echo $filtro_permanente; ?>"><span class="fas fa-angle-double-right"></a></li>
                            </ul>
                        </nav>
                    </div>
                    <div id="table-fixed" class="table-responsive table-fixed">
                        <table class="table table-bordered table-striped table-hover table-sm">
                            <thead>
                                <tr>
                                    <th></th>
                                    <th>Nombre Calculadora</th>
                                    <th>Intervalo Confianza</th>
                                    <th>Valor Z</th>
                                    <th>Varianza Estimada</th>
                            ...
                            <tbody>    
                                ...
                                <tr>
                                    <td class="align-middle text-center">
                                        <?php if($perfil_modulo=="Administrador" OR $perfil_modulo=="Gestor"): ?>
                                            <a href="gestion_cmuestral_configurar.php?reg=<?php echo base64_encode($resultado_registros[$i][0]); ?>" class="btn btn-corp btn-sm btn-width" title="Configuración"><span class="fas fa-cog"></span></a>
                                        <?php endif; ?>
                                    </td>
                                    <td class="align-middle"><?php echo $resultado_registros[$i][1]; ?></td>
                                    <td class="align-middle text-center"><?php echo $resultado_registros[$i][2]; ?>%</td>
                                    <td class="align-middle text-center"><?php echo $resultado_registros[$i][3]; ?></td>
                                    <td class="align-middle text-center"><?php echo $resultado_registros[$i][4]; ?></td>
                                    <td class="align-middle text-center"><?php echo $resultado_registros[$i][5]; ?>%</td>
