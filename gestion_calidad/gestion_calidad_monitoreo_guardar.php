<?php
    ...
    if(isset($_POST["guardar_monitoreo"])){
        ...
        if($_SESSION['monitoreo_creado']!=1){ 
            ...
            $sentencia_insert->bind_param('sssssssssssssssssssssssssss', $inser_consecutivo, $gcm_matriz, $gcm_analista, $gcm_responsable, $gcm_fecha_hora_gestion, $duracion, $gcm_tipo_monitoreo, $gcm_skill_interaccion, $gcm_tipo_gestion, $gcm_segmento, $gcm_id_sim, $gcm_id_ani, $gcm_observaciones_monitoreo, $gcm_nota_enc, $gcm_nota_ecn, $gcm_nota_ecuf, $nota_general, $control_estado_enc, $control_estado_ecn, $control_estado_ecuf, $gcm_estado, $gcm_aplica_indicador, $gcm_encuesta, $gcm_fecha_monitoreo, $gcm_auditoria, $gcm_auditoria_responsable, $_SESSION['usu_id']);
                        ...
                        /*SE ESTRUCTURA COTENIDO DE CORREO*/
                            ...
                            <table style='width: 500px; font-size: 13px; font-family: Lato, Arial, sans-serif;'>
                                <tr>
                                    ...
                                    <td style='width: 70%;padding: 5px 5px 5px 5px;background-color: #F2F2F2;'>". $inser_consecutivo ."</td>
                                </tr>
                                <tr>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <select class="form-control form-control-sm" name="indicador" id="indicador" required disabled>
                              <option value="">Seleccione</option>
                              ...
                              <?php if($perfil_modulo=="Visitante"): ?>
                                <option value="No-Cliente" <?php if(isset($_SESSION["mon_informacion"]["indicador"]) AND $_SESSION["mon_informacion"]["indicador"]=="No-Cliente"){ echo "selected"; } ?> selected>No-Cliente</option>
                              <?php endif; ?>
                            </select>
                        </div>
                    </div>
