<?php
    ...
    if(isset($_POST["guardar_registro"])){
        ...
        $consulta_actualizar = $enlace_db->prepare("UPDATE `tb_gestion_calidad_matriz` SET `gcm_nombre_matriz`=?,`gcm_estado`=?,`gcm_observaciones`=? WHERE  `gcm_id`=?");
    ...
    $consulta_string="SELECT `gcm_id`, `gcm_nombre_matriz`, `gcm_estado`, `gcm_observaciones`, `gcm_registro_usuario`, `gcm_registro_fecha` FROM `tb_gestion_calidad_matriz` WHERE `gcm_id`=?";
