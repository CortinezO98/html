<?php
    ...
    $consulta_string_historial="SELECT `gcmh_id`, `gcmh_monitoreo`, `gcmh_tipo_cambio`, `gcmh_comentarios`, `gcmh_registro_usuario`, `gcmh_registro_fecha`, TUR.`usu_nombres_apellidos` FROM `tb_gestion_calidad_monitoreo_historial` LEFT JOIN `tb_administrador_usuario` AS TUR ON `tb_gestion_calidad_monitoreo_historial`.`gcmh_registro_usuario`=TUR.`usu_id` WHERE `gcmh_monitoreo`=? ORDER BY `gcmh_registro_fecha` DESC";
        ...
        <div class="table-responsive">
            <table class="table table-bordered table-striped table-hover table-sm">
                <thead>
                    ...
                    <tr>
                        <th class="align-middle py-0 font-size-11 text-left" style="min-width: 110px;">Encuesta</th>
