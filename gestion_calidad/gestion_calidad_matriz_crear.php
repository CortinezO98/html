<?php
    ...
    if(isset($_POST["guardar_registro"])){
        ...
        if($_SESSION['registro_creado']!=1){
            ...
            $sentencia_insert = $enlace_db->prepare("INSERT INTO `tb_gestion_calidad_matriz`(`gcm_id`, `gcm_nombre_matriz`, `gcm_estado`, `gcm_observaciones`, `gcm_registro_usuario`) VALUES (?,?,?,?,?)");
