<?php
                ...
                if ($_FILES['documento']["error"][$key] > 0) {
                  ...
                  /*ahora co la funcion move_uploaded_file lo guardaremos en el destino que queramos*/
                    if (move_uploaded_file($_FILES['documento']['tmp_name'][$key], $ruta_final)) {
                        ...
                        $consulta_registro_soporte_insert = $enlace_db->prepare("INSERT INTO `tb_gestion_calidad_monitoreo_soportes`(`gcms_monitoreo`, `gcms_nombre`, `gcms_ruta`, `gcms_extension`, `gcms_registro_usuario`) VALUES (?,?,?,?,?);");
    ...
    $consulta_string_adjuntos_his="SELECT `gcmhs_id`, `gcmhs_monitoreo`, `gcmhs_nombre`, `gcmhs_ruta`, `gcmhs_extension`, `gcmhs_registro_usuario`, `gcmhs_registro_fecha` FROM `tb_gestion_calidad_monitoreo_historial_soportes` WHERE `gcmhs_monitoreo`=?";
