                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="inputGroupFile01_label" class="m-0">Adjuntar llamada <a href="#" onclick="reset_adjunto('inputGroupFile01');" class="color-rojo"><span class="fas fa-trash-alt"></span></a></label>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="inputGroupFile02_label" class="m-0">Adjuntar documento <a href="#" onclick="reset_adjunto('inputGroupFile02');" class="color-rojo"><span class="fas fa-trash-alt"></span></a></label>
                            <div class="custom-file">
