<div class="modal fade" id="dataexport" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form name="reportes_exportar" action="gestion_calidad_monitoreo_reporte_excel.php" method="POST">
                      ...
                      <div class="form-group">
                          ...
                          <select class="form-control form-control-sm" name="tipo_reporte" id="tipo_reporte" required>
                              ...
                              <?php if($perfil_modulo=="Administrador"): ?>
                                <option value="Backup">Descargar soportes retroalimentación</option>
                                <option value="Eliminar backup">Eliminar soportes retroalimentación</option>
                              <?php endif; ?>
                          </select>
                      </div>
                  </div>
