...
<body>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control form-control-sm" name="matriz" id="matriz" value="<?php echo $resultado_registros_matriz[0][1]; ?> [<?php echo $resultado_registros_matriz[$i][3]; ?>]" readonly>
                        ...
                        <div class="form-group">
                            ...
                            <select class="selectpicker form-control form-control-sm font-size-11 padding-2" data-live-search="true" name="analista" id="analista" required>
                              ...
                              <?php for ($i=0; $i < count($resultado_registros_analistas); $i++): ?> 
                                <option value="<?php echo $resultado_registros_analistas[$i][0]; ?>" class="font-size-11" data-tokens="<?php echo $resultado_registros_analistas[$i][0].' '.$resultado_registros_analistas[$i][1]; ?>" <?php if(isset($_SESSION["mon_informacion"]["analista"]) AND $_SESSION["mon_informacion"]["analista"]==$resultado_registros_analistas[$i][0]){ echo "selected"; } ?>><?php echo $resultado_registros_analistas[$i][1]; ?></option>
                              <?php endfor; ?>
                            </select>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                          ...
                          <input type="date" class="form-control form-control-sm" name="fecha_gestion" id="fecha_gestion" max="<?php echo date('Y-m-d'); ?>" value="<?php if(isset($_SESSION["mon_informacion"]["fecha_gestion"])){ echo $_SESSION["mon_informacion"]["fecha_gestion"]; } ?>" required>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                          <label for="duracion" class="m-0">Duración (minutos)</label>
                          <input type="number" class="form-control form-control-sm" name="duracion" id="duracion" step="1" min="0" max="180" value="<?php if(isset($_SESSION["mon_informacion"]["duracion"])){ echo $_SESSION["mon_informacion"]["duracion"]; } ?>" required>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <select class="form-control form-control-sm" name="skill_interaccion" id="skill_interaccion" required>
                              ...
                              <option value="Mi Familia" <?php if(isset($_SESSION["mon_informacion"]["skill_interaccion"]) AND $_SESSION["mon_informacion"]["skill_interaccion"]=="Mi Familia"){ echo "selected"; } ?>>Mi Familia</option>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <select class="form-control form-control-sm" name="tipo_gestion" id="tipo_gestion" required>
                              <option value="">Seleccione</option>
                              <option value="Acompañamiento familiar" <?php if(isset($_SESSION["mon_informacion"]["tipo_gestion"]) AND $_SESSION["mon_informacion"]["tipo_gestion"]=="Acompañamiento familiar"){ echo "selected"; } ?>>Acompañamiento familiar</option>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <select class="form-control form-control-sm" name="segmento" id="segmento" required>
                              ...
                              <option value="Mi Familia" <?php if(isset($_SESSION["mon_informacion"]["segmento"]) AND $_SESSION["mon_informacion"]["segmento"]=="Mi Familia"){ echo "selected"; } ?>>Mi Familia</option>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control form-control-sm" name="id_sim" id="id_sim" maxlength="100" value="<?php if(isset($_SESSION["mon_informacion"]["id_sim"])){ echo $_SESSION["mon_informacion"]["id_sim"]; } ?>" onkeyup="consultar_idsim();" required>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                          <label for="id_ani" class="m-0">ID/ANI</label>
                          <input type="text" class="form-control form-control-sm" name="id_ani" id="id_ani" maxlength="100" value="<?php if(isset($_SESSION["mon_informacion"]["id_ani"])){ echo $_SESSION["mon_informacion"]["id_ani"]; } ?>" required>
                        </div>
                    </div>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <select class="form-control form-control-sm" name="indicador" id="indicador" required>
                              <option value="">Seleccione</option>
                              <?php if($perfil_modulo!="Formador" AND $perfil_modulo!="Visitante"): ?>
                                <option value="Si" <?php if(isset($_SESSION["mon_informacion"]["indicador"]) AND $_SESSION["mon_informacion"]["indicador"]=="Si"){ echo "selected"; } ?>>Si</option>
                                <option value="No-Gestor" <?php if(isset($_SESSION["mon_informacion"]["indicador"]) AND $_SESSION["mon_informacion"]["indicador"]=="No-Gestor"){ echo "selected"; } ?>>No-Gestor</option>
                              <?php endif; ?>
                              <?php if($perfil_modulo=="Formador"): ?>
                                <option value="No-Formador" <?php if(isset($_SESSION["mon_informacion"]["indicador"]) AND $_SESSION["mon_informacion"]["indicador"]=="No-Formador"){ echo "selected"; } ?> selected>No-Formador</option>
                              <?php endif; ?>
                            </select>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <select class="form-control form-control-sm" name="encuesta" id="encuesta" required>
                                <option value="">Seleccione</option>
                                <option value="Si" <?php if(isset($_SESSION["mon_informacion"]["encuesta"]) AND $_SESSION["mon_informacion"]["encuesta"]=="Si"){ echo "selected"; } ?>>Si</option>
                                <option value="No" <?php if(isset($_SESSION["mon_informacion"]["encuesta"]) AND $_SESSION["mon_informacion"]["encuesta"]=="No"){ echo "selected"; } ?>>No</option>
                                <option value="No aplica" <?php if(isset($_SESSION["mon_informacion"]["encuesta"]) AND $_SESSION["mon_informacion"]["encuesta"]=="No aplica"){ echo "selected"; } ?> selected>No aplica</option>
                            </select>
                        </div>
                    </div>
                    <?php endif; ?>
    ...
    <script type="text/javascript">
        ...
        function consultar_idsim(){
            $.ajax({
                success: function(){
                    $("#coincidencias").load("gestion_calidad_monitoreo_informacion_duplicado.php?id="+$("#id_sim").val());
                }
            });
        }
    </script>
