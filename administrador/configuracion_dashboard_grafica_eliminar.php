<?php
    ...
    $titulo_header = "Dashboard Configuración | Gráfica-Eliminar";
    $id_dashboard=validar_input(base64_decode($_GET['reg']));
    $id_grafica=validar_input(base64_decode($_GET['gra']));

    if(isset($_POST["eliminar_registro"])){
        if($_SESSION['dashboard_registro_eliminado_grafica']!=1){
            // Prepara la sentencia
            $sentencia_delete_seccion = $enlace_db->prepare("DELETE FROM `tb_gestion_dashboard_grupos_graficas` WHERE `gdgg_id`=?");
            // Agrega variables a sentencia preparada
            $sentencia_delete_seccion->bind_param('s', $id_grafica);
            
            // Evalua resultado de ejecución sentencia preparada
            if ($sentencia_delete_seccion->execute()) {
                $_SESSION['dashboard_registro_eliminado_grafica']=1;
    ...
    <div class="contenido">
        ...
        <div class="row justify-content-center">
            <div class="col-md-6 pt-2 background-blanco">
                <?php if($_SESSION['dashboard_registro_eliminado_grafica']==1): ?>
                    ...
                    <div class="row">
                        <div class="col-md-2">
                            <div class="form-group">
                              ...
                              <input type="text" class="form-control form-control-sm" name="orden" id="orden" maxlength="100" value="<?php echo $resultado_registros[0][5]; ?>" disabled>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                <label for="ancho">Ancho</label>
                                <select class="form-control form-control-sm" name="ancho" id="ancho" disabled>
                        ...
                        <div class="col-md-7">
                            <div class="form-group">
                                ...
                                <select class="form-control form-control-sm" name="tipo_grafica" id="tipo_grafica" disabled>
                                  <option value="">Seleccione</option>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                              ...
                              <input type="text" class="form-control form-control-sm" name="nombre_grafica" id="nombre_grafica" maxlength="100" value="<?php echo $resultado_registros[0][3]; ?>" disabled>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="variable">Variable</label>
                                <select class="form-control form-control-sm" name="variable" id="variable" disabled>
                                      <option value="">Seleccione</option>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            <?php if(count($resultado_registros_validar)==0 AND $_SESSION['dashboard_registro_eliminado_grafica']!=1): ?>
