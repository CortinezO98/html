<?php
    ...
    $titulo_header = "Gestión Campañas | Crear";
    ...
    if(isset($_POST["guardar_registro"])){
        ...
        if($_SESSION['registro_creado']!=1){
            ...
            $sentencia_insert = $enlace_db->prepare("INSERT INTO `tb_administrador_campania`(`ac_nombre_campania`, `ac_observaciones`) VALUES (?,?)");
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control form-control-sm" name="nombre_campania" id="nombre_campania" maxlength="100" value="<?php if(isset($_POST["guardar_registro"])){ echo $nombre_campania; } ?>" <?php if($_SESSION['registro_creado']==1) { echo 'readonly'; } ?> required>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="form-group">
