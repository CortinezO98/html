...
// ini_set('display_errors', '1');
    ...
    function registro_notificacion($enlace_db=null, $id_encuesta=null, $id_seccion=null, $id_seccion_complemento=null) {
        ...
        $consulta_string_destinatarios="SELECT `gad_id`, `gad_filtro`, `gad_correos_to`, `gad_correos_cc` FROM `tb_gestion_alertas_destinatarios` WHERE `gad_filtro`='genera_alerta'";
