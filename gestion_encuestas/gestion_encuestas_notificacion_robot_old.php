<?php
    ...
    require_once("/var/www/iqgis/html/config/conexion_db.php");

    use PHPMailer\PHPMailer\PHPMailer;
    use PHPMailer\PHPMailer\Exception;
    use PHPMailer\PHPMailer\SMTP;

    require '/var/www/iqgis/html/PHPMailer-master/src/Exception.php';
    require '/var/www/iqgis/html/PHPMailer-master/src/PHPMailer.php';
    require '/var/www/iqgis/html/PHPMailer-master/src/SMTP.php';
    ...
    if (count($resultado_notificaciones)>0) {
        for ($i=0; $i < count($resultado_notificaciones); $i++) { 
            ...
            if ($resultado_notificaciones[$i][1]!="" AND $resultado_notificaciones[$i][2]!="" AND $resultado_notificaciones[$i][3]!="") {
                ...
                $num_intentos=$resultado_notificaciones[$i][12]+1;
