<div class="modal fade" id="dataexport" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form name="reportes_exportar" action="gestion_alertas_reporte_excel.php" method="POST">
                  ...
                  <div class="col-md-6">
                      <div class="form-group">
                          ...
                          <select class="form-control form-control-sm" name="estado" id="estado" required>
                              ...
                              <option value="Pendiente RN2">Revisado N1</option>
                              <option value="Escalado Regional">Escalado Regional</option>
