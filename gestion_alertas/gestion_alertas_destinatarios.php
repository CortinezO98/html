<?php
    ...
    $titulo_header = "Gestión Alertas - Configuración | Destinatarios";
    ...
    if ($filtro_permanente!="null" AND $filtro_permanente!="") {
        $filtro_buscar="AND (`gad_filtro` LIKE ? OR `gad_correos_to` LIKE ? OR `gad_correos_cc` LIKE ?)";
    ...
    $consulta_contar_string="SELECT COUNT(`gad_id`) FROM `tb_gestion_alertas_destinatarios` WHERE 1=1 ".$filtro_buscar."";
    ...
    if (!isset($_GET['pagina']) || ($pagina>$numero_paginas AND $numero_paginas>0) || $pagina<=0) {
        header('Location:gestion_alertas_destinatarios.php?pagina=1&id=null');
    }
    ...
    $consulta_string="SELECT `gad_id`, `gad_filtro`, `gad_correos_to`, `gad_correos_cc` FROM `tb_gestion_alertas_destinatarios` WHERE 1=1 ".$filtro_buscar." LIMIT ?,?";
                ...
                <form name="filtrado" action="" method="POST">
                    <div class="input-group">
                      ...
                      <span class="input-group-btn">
                        ...
                        <a href="gestion_alertas_destinatarios.php?pagina=1&id=null" class="btn btn-corp"><span class="fas fa-sync-alt"></span></a>
                      </span>
                    </div>
                </form>
            </div>
                    ...
                    <div class="col-md-12 float-left">
                        <nav aria-label="Paginación" class="paginacion">
                            <ul class="pagination justify-content-end">
                                <li class="page-item <?php echo $pagina<=1 ? 'disabled':'' ?>"><a class="page-link" href="gestion_alertas_destinatarios.php?pagina=1&id=<?php echo $filtro_permanente; ?>"><span class="fas fa-angle-double-left"></span></a></li>
                                <li class="page-item <?php echo $pagina<=1 ? 'disabled':'' ?>"><a class="page-link" href="gestion_alertas_destinatarios.php?pagina=<?php echo $pagina-1; ?>&id=<?php echo $filtro_permanente; ?>"><span class="fas fa-angle-left"></span></a></li>
                                <?php
                                ...
                                <?php for ($i=$pagina_inicio; $i <= $pagina_fin; $i++): ?>
                                    <li class="page-item <?php echo $pagina==$i ? 'active':'' ?>"><a class="page-link" href="gestion_alertas_destinatarios.php?pagina=<?php echo $i; ?>&id=<?php echo $filtro_permanente; ?>"><?php echo $i; ?></a></li>
                                <?php endfor; ?>
                                <li class="page-item <?php echo $pagina>=$numero_paginas ? 'disabled':'' ?>"><a class="page-link" href="gestion_alertas_destinatarios.php?pagina=<?php echo $pagina+1; ?>&id=<?php echo $filtro_permanente; ?>"><span class="fas fa-angle-right"></a></li>
                                <li class="page-item <?php echo $pagina>=$numero_paginas ? 'disabled':'' ?>"><a class="page-link" href="gestion_alertas_destinatarios.php?pagina=<?php echo $numero_paginas; ?>&id=<?php echo $filtro_permanente; ?>"><span class="fas fa-angle-double-right"></a></li>
                            </ul>
                        </nav>
                    </div>
                        ...
                        <table class="table table-bordered table-striped table-hover table-sm">
                            <thead>
                                <tr>
                                    ...
                                    <th class="align-middle">Filtro</th>
                                    <th class="align-middle">Correos TO</th>
                                    <th class="align-middle">Correos CC</th>
                                </tr>
                            </thead>    
                            <tbody>    
                                <?php
                                ...
                                <tr>
                                    <td class="align-middle text-center">
                                        <?php if($perfil_modulo=="Administrador"): ?>
                                            <a href="gestion_alertas_destinatarios_editar.php?pagina=<?php echo $pagina; ?>&id=<?php echo $filtro_permanente; ?>&reg=<?php echo base64_encode($resultado_registros[$i][0]); ?>" class="btn btn-primary btn-sm btn-width" title="Editar"><span class="fas fa-pen"></span></a>
                                        <?php endif; ?>
                                    </td>
