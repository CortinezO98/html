<?php
    ...
    if(isset($_POST["guardar_monitoreo"])){
        ...
        if($_SESSION['monitoreo_creado_auditoria']!=1){ 
            ...
            $sentencia_insert = $enlace_db->prepare("INSERT INTO `tb_gestion_auditoria_monitoreo`(`gcm_id`, `gcm_matriz`, `gcm_analista`, `gcm_responsable`, `gcm_fecha_hora_gestion`, `gcm_fecha_hora_cierre`, `gcm_tipo_monitoreo`, `gcm_skill_interaccion`, `gcm_tipo_gestion`, `gcm_segmento`, `gcm_id_sim`, `gcm_id_ani`, `gcm_observaciones_monitoreo`, `gcm_nota_enc`, `gcm_nota_ecn`, `gcm_nota_ecuf`, `gcm_nota_general`, `gcm_nota_enc_estado`, `gcm_nota_ecn_estado`, `gcm_nota_ecuf_estado`, `gcm_estado`, `gcm_afectacion_1`, `gcm_afectacion_2`, `gcm_fecha_monitoreo`, `gcm_registro_usuario`) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");

            // Agrega variables a sentencia preparada
            $sentencia_insert->bind_param('sssssssssssssssssssssssss', $inser_consecutivo, $gcm_matriz, $gcm_analista, $gcm_responsable, $gcm_fecha_hora_gestion, $gcm_fecha_hora_cierre, $gcm_tipo_monitoreo, $gcm_skill_interaccion, $gcm_tipo_gestion, $gcm_segmento, $gcm_id_sim, $gcm_id_ani, $gcm_observaciones_monitoreo, $gcm_nota_enc, $gcm_nota_ecn, $gcm_nota_ecuf, $nota_general, $control_estado_enc, $control_estado_ecn, $control_estado_ecuf, $gcm_estado, $gcm_afectacion_1, $gcm_afectacion_2, $gcm_fecha_monitoreo, $_SESSION['usu_id']);
            ...
            if ($sentencia_insert->execute()) {
                ...
                // Prepara la sentencia
                $sentencia_insert_calificaciones = $enlace_db->prepare("INSERT INTO `tb_gestion_auditoria_monitoreo_calificaciones`(`gcmc_monitoreo`, `gcmc_pregunta`, `gcmc_respuesta`, `gcmc_afectaciones`, `gcmc_comentarios`) VALUES (?,?,?,?,?)");
    ...
    <div class="contenido">
        ...
        <div class="row justify-content-center">
            <div class="col-md-8 pt-2 background-blanco">
                <div class="row">
                    <div class="col-md-12">
                        <p class="alert alert-success p-1">¡Se ha generado la auditoría del monitoreo <?php echo $_SESSION['id_monitoreo']; ?>!</p>
