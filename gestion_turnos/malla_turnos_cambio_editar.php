                    ...
                    <table class="table table-bordered table-striped table-hover table-sm">
                        <thead>
                            <tr>
                                ...
                                <td class="align-middle font-size-11"><?php echo $resultado_registros[0][17]; ?></td>
                            </tr>
                            <tr>
                                <th class="align-middle font-size-11 text-left" style="min-width: 110px;">Fecha</th>
                                <td class="align-middle font-size-11"><?php echo date('Y-m-d', strtotime($resultado_registros[0][4])); ?></td>
                            </tr>
                            <tr>
                                <th class="align-middle font-size-11 text-left" style="min-width: 110px;">Doc. Solicitante</th>
                                <td class="align-middle font-size-11"><?php echo $resultado_registros[0][1]; ?></td>
                            </tr>
                            <tr>
                                <th class="align-middle font-size-11 text-left" style="min-width: 110px;">Solicitante</th>
                                <td class="align-middle font-size-11"><?php echo $resultado_registros[0][2]; ?></td>
                            </tr>
                            <tr>
                                <th class="align-middle font-size-11 text-left" style="min-width: 110px;">Campaña</th>
                                <td class="align-middle font-size-11"><?php echo $resultado_registros[0][3]; ?></td>
                            </tr>
                            <tr>
                                <th class="align-middle font-size-11 text-left" style="min-width: 110px;">Turno Anterior</th>
                                <td class="align-middle font-size-11"><?php echo date('H:i', strtotime($resultado_registros[0][4])).'-'.date('H:i', strtotime($resultado_registros[0][5])); ?></td>
                            </tr>
                            <tr>
                                <th class="align-middle font-size-11 text-left" style="min-width: 110px;">Turno Nuevo</th>
                                <td class="align-middle font-size-11"><?php echo date('H:i', strtotime($resultado_registros[0][6])).'-'.date('H:i', strtotime($resultado_registros[0][7])); ?></td>
                            </tr>
                            <tr>
                                <th class="align-middle font-size-11 text-left" style="min-width: 110px;">Doc. Solicitado</th>
                                <td class="align-middle font-size-11"><?php echo $resultado_registros[0][8]; ?></td>
                            </tr>
                            <tr>
                                <th class="align-middle font-size-11 text-left" style="min-width: 110px;">Solicitado</th>
                                <td class="align-middle font-size-11"><?php echo $resultado_registros[0][9]; ?></td>
                            </tr>
                            <tr>
                                <th class="align-middle font-size-11 text-left" style="min-width: 110px;">Turno Anterior</th>
                                <td class="align-middle font-size-11"><?php echo date('H:i', strtotime($resultado_registros[0][11])).'-'.date('H:i', strtotime($resultado_registros[0][12])); ?></td>
                            </tr>
                            <tr>
                                <th class="align-middle font-size-11 text-left" style="min-width: 110px;">Turno Nuevo</th>
                                <td class="align-middle font-size-11"><?php echo date('H:i', strtotime($resultado_registros[0][13])).'-'.date('H:i', strtotime($resultado_registros[0][14])); ?></td>
                            </tr>
                            <tr>
                                <th class="align-middle font-size-11 text-left" style="min-width: 110px;">Responsable</th>
                                <td class="align-middle font-size-11"><?php echo $resultado_registros[0][16]; ?></td>
                            </tr>
                            <tr>
                                <th class="align-middle font-size-11 text-left" style="min-width: 110px;">Observaciones</th>
                                <td class="align-middle font-size-11"><?php echo $resultado_registros[0][18]; ?></td>
                            </tr>
                            <tr>
                                <th class="align-middle font-size-11 text-left" style="min-width: 110px;">Fecha Registro</th>
                                <td class="align-middle font-size-11"><?php echo $resultado_registros[0][19]; ?></td>
                            </tr>
                        </thead>
                    </table>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input type="hidden" name="estado_old" value="<?php echo $resultado_registros[0][17]; ?>">
                        </div>
                    </div>
                </div>
                <div class="row">
